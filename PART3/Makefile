...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2026/01/05 20:55:28 by ahtiftik          #+#    #+#              #
#    Updated: 2026/01/05 21:01:45 by ahtiftik         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
BONUS_SRC = ft_lstnew.c ft_lstadd_front.c ft_lstadd_back.c ft_lstdelone.c ft_lstclear.c \
...
# Kuralı sadeleştirdik ve $@ kullandık
.c.o:
		${CC} ${CFLAGS} -c $< -o $@
